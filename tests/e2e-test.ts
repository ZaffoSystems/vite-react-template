...
console.log('  - Databases: Postgres, MySQL, MongoDB, Redis, SQLite');
console.log('  - Cloud: AWS, Azure, GCP, Kubernetes, Docker');
console.log('  - VCS: GitHub, GitLab');
console.log('  - Communication: Slack, Discord, Email');
console.log('  - Browser: Puppeteer, Playwright, Browserbase');
console.log('  - Search: Brave, Google, Tavily, Exa');
console.log('  - DevOps: Linear, Jira, Sentry, Datadog');
console.log('  - Productivity: Notion, Airtable, Google Drive');
console.log('  - E-commerce: Shopify, Stripe');
console.log('  - Media: YouTube, Twitter');
...
console.log('  • Environment Variables: 110+');
